...
const char* ssid = "Ceis Master"; // Rellena con el nombre de tu red WiFi
const char* password = "Plancha2018"; // Rellena con la contraseña de tu red WiFi

const char* host = "file:///E:/ARDUINO/SMART_TRASH/index.html";
